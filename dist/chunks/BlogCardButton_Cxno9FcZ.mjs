...
const $$BlogCardButton = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$BlogCardButton;
...
}, "/home/casdavis/github/caseyjdavis/src/components/BlogCardButton.astro", void 0);

export { $$BlogCardButton as $ };
