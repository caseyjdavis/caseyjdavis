...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, r as renderTemplate, u as unescapeHTML, i as renderUniqueStylesheet, j as renderScriptElement, k as createHeadAndContent, a as renderComponent } from './astro/server_Z_zf6cj7.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_nW9BT9um.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://www.caseyjdavis.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_KAPTh-5B.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_Dbp3QWUK.mjs');
...
export { BLOG as B, CONTACT as C, DEFAULT_OUTPUT_FORMAT as D, GLOBAL as G, HOME as H, PROJECTS as P, TAGS as T, VALID_SUPPORTED_FORMATS as V, getNavigationEntries as a, getAllEntriesWithTags as b, TALKS as c, formatDate as d, readingTime as e, formatDateWithLastUpdateDate as f, getFilteredCollectionEntries as g, cn as h, DEFAULT_HASH_PROPS as i, resolvePath as r, sortByLastUpdateDate as s };
